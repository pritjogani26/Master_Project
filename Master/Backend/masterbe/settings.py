"""
Django settings for masterbe project.
...
SECRET_KEY = 'django-insecure-lh#&3s5$x7yfn@gw4_%aptt5(@di(mlm+#)1k8nd=y#92lh5%k'
...
WSGI_APPLICATION = 'masterbe.wsgi.application'
