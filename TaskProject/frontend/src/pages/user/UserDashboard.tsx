...
export default function UserDashboard() {
  const { tasks, activities, reload, setSelectedTaskId } = useUserData();
  ...
  return (
    <div className="userDashboardPage">
      <div className="userDashboardContainer">
        <UserDashboardHero
          title="Welcome back"
          subtitle="Here’s your work snapshot and top priorities for today."
        />
        ...
        <ActivityPreviewCard
          ...
          onViewAll={() => navigate("/user/activity")}
        />
      </div>
